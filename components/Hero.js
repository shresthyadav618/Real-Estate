    ...
    return(
        <div className="hero__container">
            <div className="hero__container__one">
                ...
                <p className="property-description">Explore a curated collection of residential, commercial, and plot listings designed to cater to every aspect of your lifestyle and business needs. Your perfect property is just a click away.</p>
